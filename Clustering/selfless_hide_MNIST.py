...
for e in range(5):    
    clear_session()
    train1=edit1(train,1)
    train2=edit1(train,2)
    train3=edit1(train,3)
    train4=edit1(train,4)
    x_train=train[:]
    clear_session()
...
makefile(hard_train,"hard_MNIST_hide_train.pkl")
makefile(soft_train,"soft_MNIST_hide_train.pkl")
makefile(hard_test,"hard_MNIST_hide_test.pkl")
makefile(soft_test,"soft_MNIST_hide_test.pkl")

makefile(class_hard_train,"class_hard_MNIST_hide_train.pkl")
makefile(class_soft_train,"class_soft_MNIST_hide_train.pkl")
makefile(class_hard_test,"class_hard_MNIST_hide_test.pkl")
makefile(class_soft_test,"class_soft_MNIST_hide_test.pkl")
