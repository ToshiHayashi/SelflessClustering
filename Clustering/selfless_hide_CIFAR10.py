...
makefile(hard_train,"hard_CIFAR10_hide_train.pkl")
makefile(soft_train,"soft_CIFAR10_hide_train.pkl")
makefile(hard_test,"hard_CIFAR10_hide_test.pkl")
makefile(soft_test,"soft_CIFAR10_hide_test.pkl")

makefile(class_hard_train,"class_hard_CIFAR10_hide_train.pkl")
makefile(class_soft_train,"class_soft_CIFAR10_hide_train.pkl")
makefile(class_hard_test,"class_hard_CIFAR10_hide_test.pkl")
makefile(class_soft_test,"class_soft_CIFAR10_hide_test.pkl")
