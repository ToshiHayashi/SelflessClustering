...
hard_train=np.zeros([5,3])
soft_train=np.zeros([5,3])
hard_test=np.zeros([5,3])
soft_test=np.zeros([5,3])
class_hard_train=np.zeros([5,10,3])
class_soft_train=np.zeros([5,10,3])
class_hard_test=np.zeros([5,10,3])
class_soft_test=np.zeros([5,10,3])
...
for e in range(5):    
    ...
    model.fit(self_data, self_label,
              ...
              batch_size=1000,
              shuffle=True,
              validation_data=(x_valid, y_valid),callbacks=fit_callbacks, verbose=1)
...
makefile(hard_train,"hard_CIFAR10_rot_train.pkl")
makefile(soft_train,"soft_CIFAR10_rot_train.pkl")
makefile(hard_test,"hard_CIFAR10_rot_test.pkl")
makefile(soft_test,"soft_CIFAR10_rot_test.pkl")

makefile(class_hard_train,"class_hard_CIFAR10_rot_train.pkl")
makefile(class_soft_train,"class_soft_CIFAR10_rot_train.pkl")
makefile(class_hard_test,"class_hard_CIFAR10_rot_test.pkl")
makefile(class_soft_test,"class_soft_CIFAR10_rot_test.pkl")
