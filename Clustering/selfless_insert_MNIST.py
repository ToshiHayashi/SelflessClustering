...
#train=cifar100.load_data(label_mode="coarse")[0][0]
train=fmnist.load_data()[0][0]
train_label=fmnist.load_data()[0][1]
...
#x_test1=edit1(x_train,1)
#x_test2=edit1(x_train,2)
#x_train3=edit1(x_train,3)
#x_train4=edit1(x_train,4)
#images=["Lenna.png"]
M=train.shape[1]
N=train.shape[2]
#C=train.shape[3]
...
for e in range(5):    
    ...
    if K.image_data_format() == 'channels_last':
        x_test = x_test.reshape(x_test.shape[0],M, N,C)
...
#result4.append(table4)

#print(result4)
#ave=np.array(result4).mean(axis=0)
#std=np.array(result4).std(axis=0)
#print(ave)
#print(std)
print(hard_train)
print(soft_train)
...
makefile(hard_train,"hard_FMNIST_insert_train.pkl")
makefile(soft_train,"soft_FMNIST_insert_train.pkl")
makefile(hard_test,"hard_FMNIST_insert_test.pkl")
makefile(soft_test,"soft_FMNIST_insert_test.pkl")

makefile(class_hard_train,"class_hard_FMNIST_insert_train.pkl")
makefile(class_soft_train,"class_soft_FMNIST_insert_train.pkl")
makefile(class_hard_test,"class_hard_FMNIST_insert_test.pkl")
makefile(class_soft_test,"class_soft_FMNIST_insert_test.pkl")
